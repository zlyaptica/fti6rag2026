...
## Основные функции
### init
Функция init создает клиента и формирует коллекцию. По умолчанию создание происходит в директории "./chroma_db". Коллекция по умолчанию называется "my_collection". Входные данные по умолчанию dir "./chroma_db" директория БД, collection_name: "my_collection" название коллекции.
...
### insert_query
Функция insert_query добавляет данные в коллекцию.

### delete_query
Функция delete_query удаляет данные из коллекции
